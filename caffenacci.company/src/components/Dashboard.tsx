                ...
                <div className="info-card info-card--muted">
                  ...
                  <div className="info-card__body">
                    <p className="info-card__coming-soon">
                      Zarządzanie rezerwacjami i opiniami gości będzie dostępne w kolejnych aktualizacjach panelu.
                    </p>
                  </div>
                </div>
                ...
                <div className="menu-preview-card">
                  <div className="menu-preview-card__header">
                    <div className="menu-preview-card__title-wrap">
                      <span className="info-card__icon">📋</span>
                      <h2 className="info-card__title">Menu kawiarni</h2>
                    </div>
                    <button
